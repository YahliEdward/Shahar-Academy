  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          <div ref={contactRef} className="relative">
            <button
              ...
              className="px-8 py-4 border border-white/20 text-white font-bold text-lg rounded-xl hover:bg-white/5 transition-all flex items-center gap-2"
            >
              יצירת קשר
              <svg className={`w-4 h-4 transition-transform ${contactOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-10 grid grid-cols-3 gap-6 text-center border-t border-white/10 pt-8 w-full">
          <div>
          ...
          <div>
            ...
            <div className="text-xs text-slate-400 mt-1">שעות ביום</div>
          </div>
          <div>
