    ...
    >
      <div className="relative z-10 w-full max-w-6xl 2xl:max-w-7xl mx-auto grid lg:grid-cols-[1.15fr_1fr] gap-10 items-center">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-right">
          ...
          >
            קבוצות למידה קטנות ואישיות בראש העין, עד <strong className="text-blue-600">6 תלמידים בלבד</strong> לכל קבוצה.
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-slate-400 text-xs">
        ...
        <svg className="w-4 h-4 motion-safe:animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
        </svg>
      </div>
    </section>
