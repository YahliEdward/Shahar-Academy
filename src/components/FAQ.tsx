...
const FAQS = [
  ...
  },
  {
    ...
    a: 'מבינים שהחיים קורים. אפשר לבטל עד 24 שעות מראש בלי חיוב. פשוט מעדכנים בוואטסאפ ומוצאים מועד חלופי בלוח.',
  },
  {
    q: 'איך מתבצע הרישום ואיך יודעים שהמקום שוריין?',
    a: 'בוחרים שעה פנויה בלוח השעות, ממלאים טופס קצר והמקום נשמר לכם באופן זמני. שחר שולח לכם הודעה בוואטסאפ תוך כמה שעות לאישור סופי ותיאום כל הפרטים.',
  },
  {
    q: 'אפשר לפנות לשחר בכל שאלה שעולה?',
    a: 'כן, תמיד. שחר זמין לתלמידים ולהורים בוואטסאפ בכל שעה ועונה לכל שאלה שעולה, בין אם זה קושי בשיעורי בית, התלבטות לפני מבחן או כל דבר אחר שמעסיק אתכם.',
  },
]
